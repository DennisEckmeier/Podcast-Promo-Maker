...
audio = {'filename':'outro.wav',
         'volume':'14dB', 
         'bitrate':'128k', # * 
         'codec':'aac'} # *

bkg_filename = 'tardi.png'
au_plot = {'height':60,'Ypos':560,'nChan':1}
new_vid = {'filename':'sfp_podcast.mp4',
           'fps':30,                            # *
           'size':[640,640],                    # *
           'dpi':150,                           # *
           'codec':'h264',                      # *
...
text_p = {'xpos':320,
          'ypos':10,
          'text':'Science for Societal Progress',
          'color':'w',
          'fontname':'Arial',
          'weight':'heavy',
          'size':'18',
...
#    print('frame: {}      '.format(tframe), end='\r')
    ...
    tChanHeight = au_plot['height']/au_plot['nChan']
